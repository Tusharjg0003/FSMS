                      ...
                      <div className="px-4 py-4 sm:px-6 flex items-center justify-between">
                        <div>
                          ...
                          <div className="mt-1 flex items-center text-sm text-gray-700">
                            ...
                            <p className="text-gray-800">Start: {formatDate(job.startTime)}</p>
                            {job.endTime && <><span className="mx-2 text-gray-500">-</span><p className="text-gray-800">End: {formatDate(job.endTime)}</p></>}
                          </div>
                        </div>
                        <div>
